    ...
    if ((h & 3) == 0 && (w & 3) == 0) {				        
        ...
        while (h > 0) {
            for (x = w; x > 0;) {
                ...
                default:
                    switch (h) {
                    default: YCbCrtoRGB(cp3[3], pp[15]); 
                    case 3:  YCbCrtoRGB(cp2[3], pp[11]); 
                    case 2:  YCbCrtoRGB(cp1[3], pp[ 7]); 
                    case 1:  YCbCrtoRGB(cp [3], pp[ 3]); 
                    }                                    
                case 3:
                    switch (h) {
                    default: YCbCrtoRGB(cp3[2], pp[14]); 
                    case 3:  YCbCrtoRGB(cp2[2], pp[10]); 
                    case 2:  YCbCrtoRGB(cp1[2], pp[ 6]); 
                    case 1:  YCbCrtoRGB(cp [2], pp[ 2]); 
                    }                                    
                case 2:
                    switch (h) {
                    default: YCbCrtoRGB(cp3[1], pp[13]); 
                    case 3:  YCbCrtoRGB(cp2[1], pp[ 9]); 
                    case 2:  YCbCrtoRGB(cp1[1], pp[ 5]); 
                    case 1:  YCbCrtoRGB(cp [1], pp[ 1]); 
                    }                                    
                case 1:
                    switch (h) {
                    default: YCbCrtoRGB(cp3[0], pp[12]); 
                    case 3:  YCbCrtoRGB(cp2[0], pp[ 8]); 
                    case 2:  YCbCrtoRGB(cp1[0], pp[ 4]); 
    ...
    if ((h & 3) == 0 && (w & 1) == 0) {
        ...
        while (h > 0) {
            for (x = w; x > 0;) {
                ...
                default:
                    switch (h) {
                    default: YCbCrtoRGB(cp1[3], pp[ 7]); 
                    case 1:  YCbCrtoRGB(cp [3], pp[ 3]); 
                    }                                    
                case 3:
                    switch (h) {
                    default: YCbCrtoRGB(cp1[2], pp[ 6]); 
                    case 1:  YCbCrtoRGB(cp [2], pp[ 2]); 
                    }                                    
                case 2:
                    switch (h) {
                    default: YCbCrtoRGB(cp1[1], pp[ 5]); 
                    case 1:  YCbCrtoRGB(cp [1], pp[ 1]); 
                    }                                    
                case 1:
                    switch (h) {
                    default: YCbCrtoRGB(cp1[0], pp[ 4]); 
                    case 1:  YCbCrtoRGB(cp [0], pp[ 0]); 
                    }                                    
                }
                if (x < 4) {
