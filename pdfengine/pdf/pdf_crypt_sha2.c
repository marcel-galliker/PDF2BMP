...
void base_sha256_init(base_sha256 *context)
{
...
void base_sha256_update(base_sha256 *context, const unsigned char *input, unsigned int inlen)
{
...
void base_sha256_final(base_sha256 *context, unsigned char digest[32])
{
	...
	memset(context, 0, sizeof(base_sha256));
}
